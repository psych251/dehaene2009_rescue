...
The French and Japanese words will be substituted with English words to maintain uniformity for cultural contexts. The same rules will be followed.
...
Apart from choosing a different sample size, removing a cultural group by generalizing the sample to English speakers, conductng the study online and introducing a block wise presentation of the stimuli, there are no significant differences in the current experiment design with the previous replication and orignal study.

The replication study decided to exclude trials that had response times lesser than 200ms and greater than 2000ms. However, the current study would like to enforce attention through a message and substitute trial instead of excluding trials.
